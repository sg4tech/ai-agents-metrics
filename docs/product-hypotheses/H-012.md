...
- Evidence status:
  ...
  - partially confirmed by the tracked before/after comparison inside this repository: the observed cost signal strongly favors mini, but the quality gate still needs a broader post-switch sample before this can be promoted to `validated`
- Evaluation plan:
