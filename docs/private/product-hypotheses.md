...
| `H-040` | `active` | `docs/private/product-hypotheses/H-040.md` | Session and message classification can be built from deterministic structural signals, making an LLM classifier optional rather than primary |
