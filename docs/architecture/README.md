...
|----|-------|----------|------------|--------|
| [ARCH-001](ARCH-001-cli-re-exports.md) | Remove re-exports from cli.py | high | low | open |
| [ARCH-002](ARCH-002-domain-split.md) | Split domain.py into layers | high | medium | open |
| [ARCH-003](ARCH-003-timestamps-as-datetime.md) | Store timestamps as datetime in dataclasses | medium | medium | open |
| [ARCH-004](ARCH-004-save-metrics-hidden-pop.md) | Remove hidden transformation from save_metrics | medium | low | open |
...
1. **ARCH-001** and **ARCH-005** — independent, low complexity, high ROI
2. **ARCH-004** and **ARCH-007** — isolated changes, can be picked up at any time
3. **ARCH-002** — large refactor; do gradually, one submodule at a time
4. **ARCH-003** — best done after ARCH-002 (requires a dedicated serde layer)
