...
```
 ...
 - мелкие правки юзабельности
 - пройди еще раз по графикам цены, почему-то при подсчете последнем, цена всегда null
 - общую ретру и обновление локального агентс
 - [x] сделай кодревью
 - сделать какой-то билд готовый, который можно выкладывать будет на гитхабл, в публичный достуи и интеграцию в другую проекты
