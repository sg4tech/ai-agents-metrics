...
Index for unconfirmed product and metrics ideas in `codex-metrics`.
...
| `H-006` | `validated` | `docs/product-hypotheses/H-006.md` | Retros with codified follow-up may reduce repeated failure modes more than retros alone |
| `H-007` | `validated` | `docs/product-hypotheses/H-007.md` | The generated markdown report may be optional rather than a default artifact |
