...
bandit: remind-task
	./.venv/bin/bandit -r src scripts -q --skip B404,B607,B603 --exclude scripts/permission_audit/test_claude_glob.py,scripts/permission_audit/test_check_permissions.py
