.PHONY: init check-init remind-task lint typecheck test verify build-check security bandit complexity verify-public-boundary setup-hooks dev-refresh-local package package-standalone package-refresh-local package-refresh-global live-usage-smoke public-overlay-status public-overlay-bootstrap public-overlay-verify public-overlay-push public-overlay-pull
...
verify: check-init remind-task lint security typecheck test build-check complexity
