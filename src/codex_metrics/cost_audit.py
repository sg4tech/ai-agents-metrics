...
def _build_candidate(
    ...
    *,
    ...
    return CostAuditCandidate(
        ...
        title=goal.title,
        reason=reason,
        started_at=goal.started_at.isoformat() if goal.started_at is not None else None,
        finished_at=goal.finished_at.isoformat() if goal.finished_at is not None else None,
    ...
    *,
    ...
    if is_claude_goal:
        ...
        recovered_cost_usd, recovered_total_tokens = resolve_usage_window(
            ...
            cwd,
            goal.started_at.isoformat() if goal.started_at is not None else None,
            goal.finished_at.isoformat() if goal.finished_at is not None else None,
            pricing_path,
            None,
            goal.agent_name,
        )
